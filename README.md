...
Generates a new fog color.

## void randomizeFog()
If a fog is enabled, fog colour is set to the color generated by _generateFogColor()_ and transparency is randomly decided. 

## void generateDistractors()
If distractors are enabled, this function spawns a random number of distractors in randomized pose within the camera view.
